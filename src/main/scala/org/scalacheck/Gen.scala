...
object Gen extends GenArities{
   ...
   *  implicit [[org.scalacheck.util.Buildable]] instance. The elements in the
   *  container will be generated by the given generator. If the given generator
   *  fails generating a value, the complete container generator will also fail.
   *
   *  The size of the generated container is limited by `n`. Depending on what
   *  kind of container is generated, the resulting container may contain fewer
