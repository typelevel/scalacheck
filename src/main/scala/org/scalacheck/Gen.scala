...
object Gen {
   ...
   *  bounded by the size parameter used when generating values. */
  def container2Of[C[_,_],T,U](g: Gen[(T,U)])(implicit b: Buildable2[T,U,C]): Gen[C[T,U]] =
    sized(size => for(n <- choose(0,size); c <- container2OfN[C,T,U](n,g)) yield c)

  /** Generates a non-empty container of any type for which there exists an
   *  implicit <code>Buildable2</code> instance. The elements in the container
   *  will be generated by the given generator. The size of the container is
   *  bounded by the size parameter used when generating values. */
  def nonEmptyContainer2Of[C[_,_],T,U](g: Gen[(T,U)])(implicit b: Buildable2[T,U,C]): Gen[C[T,U]] =
    sized(size => for(n <- choose(1,size); c <- container2OfN[C,T,U](n,g)) yield c)

  /** Generates a non-empty container of any type for which there exists an
   *  implicit <code>Buildable2</code> instance. The elements in the container
   *  will be generated by the given generator. The size of the container is
   *  bounded by the size parameter used when generating values. */
  @deprecated("Use Gen.nonEmptyContainer2Of instead", "1.11.0")
  def container2Of1[C[_,_],T,U](g: Gen[(T,U)])(implicit b: Buildable2[T,U,C]): Gen[C[T,U]] =
    nonEmptyContainer2Of[C,T,U](g)
   ...
   *  size parameter. This method is equal to calling
   *  <code>container2Of[Map,T,U](g)</code>. */
  def mapOf[T,U](g: => Gen[(T,U)]) = container2Of[Map,T,U](g)

  /** Generates a non-empty map of random length. The maximum length depends
   *  on the size parameter. This method is equal to calling
   *  <code>nonEmptyContainer2Of[Map,T,U](g)</code>. */
  def nonEmptyMap[T,U](g: => Gen[(T,U)]) = nonEmptyContainer2Of[Map,T,U](g)

  /** Generates a map of the given length. This method is equal to calling
   *  <code>containerOfN[List,T](n,g)</code>. */
  def mapOfN[T,U](n: Int, g: Gen[(T,U)]) = container2OfN[Map,T,U](n,g)
